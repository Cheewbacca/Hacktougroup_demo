...
(function ($) {
  ...
  var createConnection = function createConnection(container, nodes, tag, borderClasses, options) {
    var css = $.extend({
      position: "absolute"
    }, options.css);
  ...
  var destroy = function destroy(connection) {
  ...
  var getState = function getState(data) {
  ...
  var processConnections = function processConnections(method, elements) {
